...
const walks = defineCollection({
  ...
  schema: z.object({
    ...
    starting_point: z.string().default("捷運出口"),
    starting_mrt: z.string().optional(),
    starting_direction: z.string().optional(),
    starting_coords: z.tuple([z.number(), z.number()]).optional(), // [lng, lat]
    estimated_duration: z.string(),
    total_stamina_cost: z.number().min(1).max(5),
    spot_sequence: z.array(z.string()),
    walking_connections: z.array(z.string()).optional(),
